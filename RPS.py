...
def player(prev_opponent_play, opponent_history = []):
    global my_history, prev_play, opponent_list, ideal_response, opponent_one_counter, play_order
    ...
    if(opponent_list[0]):
        ...
        opponent_one_list = ['P', 'S', 'S', 'R', 'P'] 
        opponent_one_counter = (opponent_one_counter + 1) % 5
        return opponent_one_list[opponent_one_counter]
